                          ...
                          db.InsertDocument('transaction', transaction, function(err, transaction) {
                            if (err || transaction.nModified == 0) {
                              ...
                              db.UpdateDocument('task', {
                                ...
                                'history.job_closed_time': job_cancellation_time
                              }, {}, function(err, upda) {
                    ...
                    if (err || !wallet) {
                      ...
                      if (wallet.total == 0) {
                        res.send({
                          ...
                          'Amount neeeds': Bookings.invoice.amount.total
                        });
                                              ...
                                              if (err) {
                                                ...
                                                db.GetDocument('emailtemplate', {
                                                  ...
                                                  if (err) {
                                                    ...
                                                    html2 = html2.replace(/{{taskeraddress1}}/g, maildocdata.tasker.availability_address);
                        ...
                        db.UpdateDocument('walletReacharge', {
                          ...
                          $set: {
                            "total": parseFloat(wallet.total - Bookings.invoice.amount.balance_amount)
                          }
                        }, {
                          multi: true
                        }, function(walletUErr, walletURespo) {
