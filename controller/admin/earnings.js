                ...
                var earningQuery = [
                    ...
                    },
                    {
                        $project: {
                            _id: 0,
                            cash: {
                                admin_commission: '$cash_admin_commission',
                                coupon: '$cash_coupon',
                                grandtotal: '$cash_grandtotal',
                                total: '$cash_total',
                                servicetax: '$cash_servicetax',
                                paid_count: '$cash_paid_count',
                                extra_amount: '$cash_extra_amount'
                            },
                            gateway: {
                                admin_commission: '$gateway_admin_commission',
                                coupon: '$gateway_coupon',
                                grandtotal: '$gateway_grandtotal',
                                total: '$gateway_total',
                                servicetax: '$gateway_servicetax',
                                paid_count: '$gateway_paid_count',
                                extra_amount: '$gateway_extra_amount'
                            },
                            total: {
                                admin_commission: { $sum: ["$cash_admin_commission", "$gateway_admin_commission"] },
                                coupon: { $sum: ["$cash_coupon", "$gateway_coupon"] },
                                grandtotal: { $sum: ["$cash_grandtotal", "$gateway_grandtotal"] },
                                total: { $sum: ["$cash_total", "$gateway_total"] },
                                servicetax: { $sum: ["$cash_servicetax", "$gateway_servicetax"] },
                                paid_count: { $sum: ["$cash_paid_count", "$gateway_paid_count"] },
                                extra_amount: { $sum: ["$cash_extra_amount", "$gateway_extra_amount"] }
                            },
                            count: 1,
                            tasker: 1,
                        }
