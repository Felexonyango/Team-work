    ...
    try {
        ...
        */
        ...
        app.get('/*', function (req, res) {
            db.GetDocument('settings', { "alias": { "$in": ["general", "seo"] } }, {}, {}, function (err, docdata,settings) {
                if (settings) {
                    settings.title = docdata[1].seo_title;
                    settings.description = docdata[1].meta_description;
                    settings.image = docdata[0].site_url + docdata[0].logo;
                    settings.siteUrl = docdata[0].site_url;
